...
APPSMITH_OAUTH2_GITHUB_CLIENT_ID=enabled
APPSMITH_OAUTH2_GITHUB_CLIENT_SECRET=enabled
APPSMITH_OAUTH2_GOOGLE_CLIENT_ID=enabled
APPSMITH_OAUTH2_GOOGLE_CLIENT_SECRET=enabled
